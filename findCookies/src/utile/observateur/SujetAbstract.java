 ...
 */
public abstract class SujetAbstract implements Sujet {

    /**
     * liste des observateurs abonnés au Sujet observés, l'unicité des instances dans la liste est garantit
     * @see SujetAbstract#attacher(Observateur)
     * @see SujetAbstract#detacher(Observateur)
     */
